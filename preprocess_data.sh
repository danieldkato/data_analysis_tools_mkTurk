...
SCRIPT_DIR="/home/yy3658/helpers/data_analysis_tools_mkTurk"
...
python /mnt/smb/locker/issa-locker/users/Dan/code/scripts/preprocessing/generate_psth_files.py --monkey "$MONKEY" --date "$DATE"
